        ...
        <div class="table-responsive">
            <table class="table ">
                <tr class="text-center">
                    <td>
                        <a href="{{ route('appointment.index') }}" class="btn btn-info" title="Quay lại">
                            <i class="fas fa-arrow-left me-2" data-bs-toggle="tooltip"></i>Quay lại
                        </a>&nbsp;
                       
                        {{-- Phản hồi nếu: Y Tá bất kỳ hoặc Bác sĩ đúng người --}}
                        @if ($admin->hasRole('Y Tá') || ($admin->hasRole('Bác sĩ') && $appointment->doctor_id == $admin->id))
                        ...
                        {{-- Xóa nếu: Y Tá bất kỳ hoặc Bác sĩ đúng người --}}
                        @if ($admin->hasRole('Y Tá') || ($admin->hasRole('Bác sĩ') && $appointment->doctor_id == $admin->id))
